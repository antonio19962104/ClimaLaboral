...
namespace BL
{
    public class Encuesta2
    {
        ...
        public static ML.Result getEncuestaById(int idEncuesta)
        {
            ML.Result result = new ML.Result();
            try
            {
                using (DL.RH_DesEntities contex = new DL.RH_DesEntities())
                {
                    ...
                    if (query != null)
                    {
                        foreach (var obj in query)
                        {
                            ...
                            encuesta.ListCompetencias = new List<object>();//listadoCompetenciaPreguntas.ListadoCompetenciasPregunta;
        ...
        public static ML.Result getEncuestaByIdEdit(int idEncuesta)
        {
            ML.Result result = new ML.Result();
            try
            {
                using (DL.RH_DesEntities contex = new DL.RH_DesEntities())
                {
                    ...
                    if (query != null)
                    {
                        foreach (var obj in query)
                        {
                            ...
                            encuesta.UsuarioCreacion = obj.UsuarioCreacion;
                            //Preguntas
                            encuesta.NewCuestionEdit = BL.Preguntas.getAllPreguntasByIdEncuestaEdit(obj.IdEncuesta);
                            //encuesta.NewCuestion = BL.Preguntas.getAllPreguntasByIdEncuesta(obj.IdEncuesta);
                            //Base de datos
                            encuesta.BasesDeDatos = new ML.BasesDeDatos();
                            encuesta.BasesDeDatos.IdBaseDeDatos = obj.IdBasesDeDatos;
        ...
        public static ML.Result getEncuestaByIdConfigura(int idEncuesta)
        {
            ML.Result result = new ML.Result();
            try
            {
        ...
        public static ML.Result getEncuestaByIdConfiguraForEdit(int idEncuesta)
        {
            ML.Result result = new ML.Result();
            try
            {

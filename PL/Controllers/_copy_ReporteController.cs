...
{
    public class _copy_ReporteController : Controller    
    {
        List<List<int>> listaGlobal = new List<List<int>>();
        public ActionResult GetEstructuraForAbiertas(ML.CompanyCategoria CompanyCateg)
        {
            /*Validar repetidos*/
            ...
            try
            {
                using (DL.RH_DesEntities context = new DL.RH_DesEntities())
                {
                    ...
                    var query = context.getComentarios(CompanyCateg.Descripcion).ToList();
        ...
        public ActionResult ReporteGetByUnidadNegocio(string UNegocio)
        {
            //Enviar Catalogo de unidades de negocio usando viewbag
            var result = BL.Reporte.GetResultadosByUnidadNegocio(UNegocio);
        ...
        //Reporte master
        public ActionResult GetEsperadas(ML.ReporteD4U model)
        {
            try
            {
        ...
        public ActionResult GetPorcentajeParticipacionEnfoqueEmpresa(ML.ReporteD4U model)
        {
            try
            {
                List<double> resultados = new List<double>();
        ...
        public JsonResult GetPromediosCreedibilidadEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosImparcialidadEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosOrgulloEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosRespetoEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosCompañerismoEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosCoachingEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPrmediosCambio
        public JsonResult GetPromediosCambioEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public ActionResult GetPromediosBienestarEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public ActionResult GetPromediosAlinCulturalEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public ActionResult GetPromediosGestaltEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosConfianzaEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromedios66ReactivosEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public ActionResult GetPromedios86ReactivosEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosPracticasCulturealesEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public ActionResult GetPromediosReclutandoBienvenidaEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosAlineacionEstrategicaEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosProcesosOrganizacionalesEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosNivelCoolaboracionEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosNivelCompromisoEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //**********************ENFOQUE AREA************************//
        //**********************ENFOQUE AREA************************//
        public JsonResult GetPromediosCreedibilidadEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosImparcialidadEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosOrgulloEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosRespetoEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosCompañerismoEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosCoachingEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPrmediosCambio
        public JsonResult GetPromediosCambioEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        public JsonResult GetPromediosConfianzaEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPromedios 66 Reactivos
        public JsonResult GetPromedios66ReactivosEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPromedio 86 Reactivos
        public ActionResult GetPromedios86ReactivosEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPromedio PracticasCultureales
        public JsonResult GetPromediosPracticasCulturealesEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPromedioAlineacionEstrategica
        public JsonResult GetPromediosAlineacionEstrategicaEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPromedioProcesosOrganizacionales
        public JsonResult GetPromediosProcesosOrganizacionalesEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //GetPromedioNivelCoolaboracion
        public JsonResult GetPromediosNivelCoolaboracionEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        //getPromedioNivelCompromiso
        public JsonResult GetPromediosNivelCompromisoEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
        ...
        /*Metodos faltantes*/
        public JsonResult GetPromediosHabilidadesGerencialesEnfoqueEmpresa(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
                ...
                {
                    //Metodo por unidad de negocio
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByUNegocioEE(DataForFilter);
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByGeneroEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByFuncionEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByCondicionTrabajoEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByGradoAcademicoEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByRangoAntiguedadEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesRangoEdadEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByCompanyEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByAreaEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByDepartamentoEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesBySubDepartamentoEE(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
        ...
        public JsonResult GetPromediosHabilidadesGerencialesEnfoqueArea(ML.ReporteD4U model)
        {
            List<double> resultados = new List<double>();
            foreach (string item in model.ListFiltros)
            {
                ...
                {
                    //Metodo por unidad de negocio
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByUNegocioEA(DataForFilter);
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByGeneroEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByFuncionEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByCondicionTrabajoEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByGradoAcademicoEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByRangoAntiguedadEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesRangoEdadEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByCompanyEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByAreaEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesByDepartamentoEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
                ...
                {
                    //Metodo por genero
                    var result = BL.ReporteD4U.GetPromedioHabilidadesGerencialesBySubDepartamentoEA(DataForFilter, model.UnidadNegocioFilter);
                    if (Double.IsNaN(result) == true)
                    {
                        result = 0;
                    }
        ...
        public JsonResult GetMejoresEE(ML.ReporteD4U model, int anioActual)
        {
